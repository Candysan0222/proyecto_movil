...
import 'pages/imageSpinner.dart';
import 'pages/welcomeLogin.dart';
                ...
                TextButton(
                  onPressed: () {
                    Navigator.of(context)
                        .pop(false); // Cancelar y seguir en la app
                  },
                  child: Text('Cancelar'),
                ),
                TextButton(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: const Text(
                        ...
                        style: TextStyle(color: Color.fromARGB(255, 4, 50, 88)),
                      ),
                    ),
                    const SizedBox(height: 20),
                    SignInButton(
