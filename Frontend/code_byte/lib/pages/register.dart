...
import 'package:code_byte/service/userService.dart'; // Asegúrate de importar tu modelo de Persona
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void _validateInput(String inputType) {
    if (inputType == 'username') {
      setState(() {
        isUsernameValid =
            !RegExp(r'[^a-zA-Z0-9]').hasMatch(usernameController.text);
        if (!isUsernameValid) {
          _showAlert(
  ...
  void _registerUser() async {
    ...
    final userData = {
      ...
      'profilePhoto':
          'url_o_ruta_de_foto', // Ruta de la foto de perfil si la tienes
      ...
      'documentPhoto':
          'url_o_ruta_documento', // Asegúrate de almacenar esta información en el modelo de Persona
    ...
    try {
      await userService
          .registerUser(userData); // Llama al método desde la instancia
